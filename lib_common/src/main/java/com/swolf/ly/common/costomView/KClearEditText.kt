 ...
 */
class KClearEditText @JvmOverloads constructor(
    context: Context,
    ...
    private fun init() {
        ...
        if (mClearDrawable == null) {
            val bmp = BitmapFactory.decodeResource(resources, R.mipmap.ny_delete)
            mClearDrawable = BitmapDrawable(resources, bmp)
        }
