 ...
 */
class KCircleImageView : ImageView {
    ...
    constructor(context: Context, attrs: AttributeSet, defStyle: Int = 0) : super(context, attrs, defStyle) {
        ...
        val a = context.obtainStyledAttributes(attrs, R.styleable.ny_CircleImageView, defStyle, 0)

        mBorderWidth = a.getDimensionPixelSize(R.styleable.ny_CircleImageView_civ_border_width, DEFAULT_BORDER_WIDTH)
        mBorderColor = a.getColor(R.styleable.ny_CircleImageView_civ_border_color, DEFAULT_BORDER_COLOR)
        mBorderOverlay = a.getBoolean(R.styleable.ny_CircleImageView_civ_border_overlay, DEFAULT_BORDER_OVERLAY)
        mFillColor = a.getColor(R.styleable.ny_CircleImageView_civ_fill_color, DEFAULT_FILL_COLOR)
