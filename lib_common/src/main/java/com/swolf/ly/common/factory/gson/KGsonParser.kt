...
object KGsonParser {
    ...
    fun <T> jsonStr2Object(json: String, typeToken: TypeToken<T>, dateFormatStr: String?="yyyy-MM-dd HH:mm:ss"): T? {
        var dateFormatString = dateFormatStr
        try {
     ...
     */
    @JvmOverloads
    fun object2JsonStr(obj: Any, dateFormatStr: String = "yyyy-MM-dd HH:mm:ss"): String {
        var dateFormatString = dateFormatStr
        try {
