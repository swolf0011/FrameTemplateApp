...
class KPopupWindowUtil {
    ...
    fun showViewBottom(
        ...
        initPopupWindow(view, w, h, -1, d, listener)
...
//        val popupHeight = view.measuredHeight
    ...
    fun showViewTop(
        ...
        initPopupWindow(view, width, height, -1, d, listener)
        val location = IntArray(2)
        clickParentView.getLocationOnScreen(location)
    ...
    fun showScreenBottom(
        ...
        initPopupWindow(view, width, height, R.style.ny_screen_bottombar_popupwindow_anim, d, listener)
